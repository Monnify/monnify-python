...
class TestSingleDisbursementAPIs:
    ...
    def instantiate_class(self):
        self.__instance = DisbursementSingle(os.environ.get('API_KEY'),os.environ.get('SECRET_KEY'))
...
class TestBulkDisbursementAPIs:
    ...
    @pytest.fixture(autouse=True)
    def instantiate_class(self):
        self.__instance = DisibursementBulk(os.environ.get('API_KEY'),os.environ.get('SECRET_KEY'))
