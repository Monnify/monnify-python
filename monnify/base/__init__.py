...
class Base:
       ...
       def __init__(self:object, API_KEY:str=None, SECRET_KEY:str=None,ENV:str='SANDBOX') -> None:
              ...
              if(API_KEY is None or SECRET_KEY is None):
                     ...
                     raise Exception("Unkwown environment supplied, either supply 'SANDBOX' or 'LIVE'")
       ...
       def compute_hash(self:object, payload:bytes, monnify_signature:str) -> bool:

              secret_key_bytes:bytes = self.__secret_key.encode("utf-8")
              hash_in_bytes:bytes = hmac.new(secret_key_bytes, msg=payload, digestmod=hashlib.sha512)
